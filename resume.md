...
- Coursework also included statistics and computer science.
- Student journalist for Amherst College publications.
- Internship in data science with the Dutch National Institute for Public Health and the Environment (RIVM), resulting in a first-author peer-reviewed publication.

**Communications Skills** ```Public Speaking``` ```Discussion Moderation``` ```Interviewing and Oral History``` ```Public Writing and Blogging```

**Language Skills** ```French``` ```Dutch``` ```German``` ```Spanish```

**Digital Humanities and Technical Skills** ```Data Analysis (R)```  ```Application Development (Shiny, Leaflet)``` ```Digital Exhibits (Omeka, ArcGIS Story Maps, Wax)``` ```Web Scraping (Python)``` ```Front-End Development (Jekyll, Markdown, GitHub)```

## Experience

### Teaching Fellow, Yale University Graduate School of Arts and Sciences
...
### Freelance Copywriter, Berkeley Bridge

2018-2019, Alphen aan den Rijn, Netherlands

- Researched and drafted 3 white papers about new projects within the company.
- Researched and drafted 10 customer case stories for the company website. Conducted interviews with clients about their history and collaborations with the company.
- Drafted and workshopped ad copy for banners and landing pages.
- Translated marketing materials and brochures into English.

### Museum Docent, Beneski Museum of Natural History at Amherst College

2014-2018, Amherst, MA
...
- Contacted and interviewed firsthand witnesses of the Carifesta events about their experiences.
- Conducted in-depth archival research to supplement oral history accounts and fill out biographical information about my subjects.
- Coordinated the exhibit with the project sponsor, the Digital Library of the Caribbean.
